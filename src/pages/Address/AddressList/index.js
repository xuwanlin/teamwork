...
export default class AddressList extends Component {
  constructor(){
    super();
    this.state = {name:'',phone:'',address:'',email:''}
}
  SubmitOk = () => {
    ...
    post('/api/user',{name,phone,address,email}).then(res => {
      if (res.code === 0) {
      ...
      <Mheader title="修改收货地址"/>
        <div className="ul-one">
          <ul>
            ...
            <li><label>电话</label><input ref={input=>this.phone=input} type="text" className="list-phone"/></li>
